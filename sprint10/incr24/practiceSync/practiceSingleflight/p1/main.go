...
func (c *cache) refreshKey(ctx context.Context, key CacheKey) (interface{}, error) {
...
func (p *mockValueProvider) GetValue(ctx context.Context,
	key CacheKey) (interface{}, time.Time, error) {
	if !p.called {
		p.called = true
