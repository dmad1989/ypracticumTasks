...
// конструктор конвертера с пропускной способностью n
...
func (e *videoEncoder) SubmitEncodingTask(ctx context.Context,
	file VideoFile) (chan EncodingResult, error) {
...
func (e *videoEncoder) doEncode(ctx context.Context, file VideoFile) (chan EncodingResult, error) {
